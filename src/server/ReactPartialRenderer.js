 ...
 *
 * Portions of this source code are licensed under the MIT license found in 
...
class ReactDOMServerRenderer {
  ...
  async read(bytes: number, cache:any, isStreaming:any, streamingStart:any, memLife:number): string | null {
    /* 
    ...
    while (out.length < bytes) {
     ...
     if (child.props && child.props.cache) {
      ...
      if (isTemplate) {
        ...
        var cacheProps = Object.assign({}, child.props); 
