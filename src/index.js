...
if (process.env.NODE_ENV !== "production") {
  (function() {
    ...
    var ReactDOMServerRenderer = (function() {
      ...
      ReactDOMServerRenderer.prototype.read = async function read(
        bytes,
        cache,
        isStreaming,
        streamingStart,
      ...
      */
          if (child.props && child.props.cache) {
            ...
            if (isTemplate && loadedTemplates[cacheKey]) {
              ...
              restoredTemplate = restoreProps(
                loadedTemplates[cacheKey],
                realProps,
                lookup
              );
            } else {
    ...
    */
        if (!isStreaming) {
          for (let component in start) {
            ...
            let tagEnd;
            let componentStart =
              typeof start[component] === "object"
                ? start[component].startIndex
                : start[component];
          ...
          if (saveTemplates) {
            ...
            saveTemplates.forEach(savedTemplate => {
              ...
              out += restoreProps(
                outCopy.slice(savedTemplate.startIndex, savedTemplate.endIndex),
                savedTemplate.realProps,
                savedTemplate.lookup
              );
            });
    ...
    var renderToString = require('./stringMethods').renderToString;
    var renderToStaticMarkup = require('./stringMethods').renderToStaticMarkup;
    var renderToNodeStream = require('./streamingMethods').renderToNodeStream;
    var renderToStaticNodeStream = require('./streamingMethods').renderToStaticNodeStream;
    ...
    var ReactDOMServerNode = {
      ...
      ReactDOMServerRenderer: ReactDOMServerRenderer,
